...
import { FlipDotGrid, type Frames } from "@/components/flip-dot-matrix";
...
export const FlipDotGridDemo: React.FC = () => {
  ...
  return (
    <Demo>
      <div className="flex cursor-pointer items-center justify-center gap-3 rounded-xl bg-gray-300 px-3 py-6 hover:scale-105">
        <FlipDotGrid
          gridSize={[5, 5]}
