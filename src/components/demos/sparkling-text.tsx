...
export const SparklingText: React.FC<Props> = ({
  children,
  alwaysAnimate = false,
  frequency = 250,
}) => {
  ...
  return (
    <span
      className={styles.sparkle__container}
    ...
    >
      {sparkles.map((sparkle) => (
        <span
          ...
          className={styles.sparkle__sparkle}
          style={sparkle.style}
        >
      ...
      <span className={styles.sparkle__text}>{children}</span>
    </span>
  );
};
