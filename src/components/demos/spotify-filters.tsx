    ...
    <div ref={containerRef} className="flex items-center gap-2">
      ...
      {FILTERS.map((filter, index) => (
        <button
          ...
          className="flex h-8 cursor-pointer items-center justify-center rounded-2xl bg-neutral-800 px-4 text-sm text-white opacity-100 transition-colors duration-300 ease-in-out not-aria-checked:hover:brightness-125 disabled:pointer-events-none disabled:opacity-0 aria-checked:bg-green-600 aria-checked:text-white dark:aria-checked:text-black"
          style={{
