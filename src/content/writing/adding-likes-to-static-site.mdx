...
image:
  src: "https://res.cloudinary.com/dx73a1lse/image/upload/v1699994715/blog/adding-likes-thumbnail_gvj01i.webp"
  alt: "Adding likes to a static blog site"
---

import { LikeButtonDemo } from "@/components/demos/like-button.tsx";
