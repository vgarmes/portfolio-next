...
That said, both sites score well on Total Blocking Time and Cumulative Layout Shift, and the Next.js score of 91 is still good. For a content-heavy blog, Astro's approach to JavaScript is hard to beat.
