...
However, there's no built-in content collection system. For this reason, I chose [Fumadocs MDX](https://fumadocs.vercel.app/) to fill that gap (I wrote more about Fumadocs in <Link href="/writing/how-shadcn-documentation-is-built">How shadcn's Documentation is Built</Link>, which provides a similar developer experience with `defineCollections`:
