...
image:
  src: "https://res.cloudinary.com/dx73a1lse/image/upload/v1689889088/blog/overview_ugl3u2.webp"
...
Choose a font of your preference (I chose _Hack_), download it, and unzip the file. Then, right-click on the font file and select _Install_ to install it on your system.
...
Additionally, within the **Appearance** tab, you have the option to customize the color scheme according to your preference. Personally, I prefer dark themes for everything, so I chose the _One Half Dark_ theme.
